...
public class ObjectController : MonoBehaviour
{
    ...
    /// <returns></returns>
    public IEnumerator MoveObjectCurveV2(bool isRect, GameObject obj, Vector2 startPos, Vector2 targetPos, float duration, AnimationCurve animCurve)
    {
    ...
    /// <param name="animCurve">đường cong move</param>
    /// <returns></returns>
    public IEnumerator MoveObjectCurve(bool isRect, GameObject obj, Vector3 startPos, Vector3 targetPos, float duration, AnimationCurve animCurve)
    {
        var rect = isRect ? obj.GetComponent<RectTransform>() : null;
        var rect2 = isRect ? null : obj.GetComponent<Transform>();
        float time = 0;
